@echo off
title Windows 10 ALL Builds activator&cls&echo ************************************ &echo Provided by: Fiverr.com\XtremeRocx &echo.&echo Supported products:&echo - Windows 10 Home&echo - Windows 10 Professional&echo - Windows 10 Enterprise, Enterprise LTSB&echo - Windows 10 Education&echo.&echo.&echo ************************************ &echo Windows 10 activation...
